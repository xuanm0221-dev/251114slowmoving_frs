...
export const REMARK_PERIODS = [
  ...
  { range: '25.12', remark: 'operate_standard', source: 'HST_PRDT_SCS (202601)' },
  { range: '26.01', remark: 'operate_standard', source: 'HST_PRDT_SCS (202602)' },
  { range: '26.02', remark: 'operate_standard', source: 'HST_PRDT_SCS (202603)' },
  { range: '26.03', remark: 'operate_standard', source: 'HST_PRDT_SCS (202604)' },

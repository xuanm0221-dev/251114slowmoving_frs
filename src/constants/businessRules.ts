 ...
 *     26.04→PREP 202605, 26.05→PREP 202606 …
...
export const REMARK_PERIODS = [
  ...
  { range: '26.04', remark: 'operate_standard', source: 'PREP_MST_PRDT_SCS (202605)' },
  { range: '26.05', remark: 'operate_standard', source: 'PREP_MST_PRDT_SCS (202606)' },
  { range: '26.06 ★현재', remark: 'operate_standard', source: 'MST_PRDT_SCS (실시간)' },
] as const;

 ...
 *     25.12→PREP 202601, 26.01→PREP 202602, 26.02→PREP 202603, 26.03→PREP 202604, 26.04→PREP 202605 …
...
export const REMARK_PERIODS = [
  ...
  { range: '26.05 ★현재', remark: 'operate_standard', source: 'MST_PRDT_SCS (실시간)' },
] as const;
